package com.mohistmc.exoticgarden.items;

import com.mohistmc.exoticgarden.CustomPotion;
...
public final class FoodRegistry {
    ...
    public static void register(@Nonnull ExoticGarden plugin, @Nonnull ItemGroup misc, @Nonnull ItemGroup drinks, @Nonnull ItemGroup food) {
        ...
        new CustomFood(food, new SlimefunItemStack("STUFFED_RED_BELL_PEPPER", "b6c98b410123b0944422303798fc2db8cea0feeb09d0da40f5361b59498f3e8b", "&c红椒酿", "", "&7&o恢复 &b&o" + "7.0" + " &7&o点饥饿值"),
